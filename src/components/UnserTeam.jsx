      ...
      <div className="bg-gray-200 text-black p-6 rounded-lg shadow-lg max-w-4xl relative mx-5 text-xs md:text-base text-center">
        ...
        <div className="flex flex-col justify-center items-center">
          ...
          <div className="mt-4 mb-6">
            Unser Erfolg basiert auf einem engagierten Team, das durch
            Vielfalt und Fachkompetenz besticht. Jedes Teammitglied bringt
            einzigartige Fähigkeiten ein, die zusammen eine starke Einheit
            bilden.
          </div>
          <div className="flex flex-col gap-y-4 md:flex-row md:flex-wrap md:gap-x-5 text-sm md:text-base">
            <div className="flex-1 min-w-[150px]">
              <strong>Amina Diallo</strong> – Geschäftsführerin<br />
              Über 20 Jahre Erfahrung und Engagement für exzellenten
              Kundenservice.
            </div>
            <div className="flex-1 min-w-[150px]">
              <strong>Rafael Costa</strong> – Leiter Vertrieb<br />
              Über 15 Jahre Erfahrung im Vertrieb und umfassendes Wissen über
              den Immobilienmarkt.
            </div>
            <div className="flex-1 min-w-[150px]">
              <strong>Laura Schmidt</strong> – Immobilienberaterin<br />
              Expertise in der Immobilienwirtschaft und ein feines Gespür für
              Details.
            </div>
            <div className="flex-1 min-w-[150px]">
              <strong>Paul Fischer</strong> – Marketingmanagerr<br />
              Kreativ und erfahren in digitalem Marketing und Markenpräsenz.
            </div>
            <div className="flex-1 min-w-[150px]">
              <strong>Jonas Weber</strong> – Kundenbetreuer<br />
